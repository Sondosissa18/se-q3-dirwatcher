...
def dir_dictionary(polling_dict, ns):
    """ 
    # 1: if there is a file in the polling dictionary , thats not in global dict, that means that user have added a file recently.
    # 2 : if the global dictionary  has a file that  the polling dictionary does not have that means it been deleted"""
    try:
